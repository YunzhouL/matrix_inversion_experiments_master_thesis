% This program is a modified version of Test_5_1_1_1,
% which uses MATLAB's inv operator for matrix inversion
...
for idx = 1:length(matrix_sizes)
    ...
    for trial = 1:num_trials
        ...
        % Method 1: Direct inversion using MATLAB's inv operator
        tic;
        M_inv1 = inv(M);
        times(trial, 1) = toc;
...
% filename = fullfile(pwd, 'Fig_5_1_1_2.png');
