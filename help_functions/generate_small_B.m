% This function is used in conjunction with generate_big_B to create test matrices
...
function [A, B] = generate_small_B(n, kappa)
    % Generate two diagonal matrices A and B with
    % κ(A) = kappa and κ(B) = kappa/10
