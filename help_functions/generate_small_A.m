% This function is used in conjunction with generate_big_A to create test matrices
...
function [A, B] = generate_small_A(n, kappa)
    % Generate two diagonal matrices A and B with
    % κ(B) = kappa and κ(A) = kappa/10
